...
SHELLS = [
    ...
    dict(
        ...
        why=p(
            "Understanding and knowledge meet and something new has to get born. EMT is the translation desk — concordance, code bay, two languages looking at each other.",
        ),
